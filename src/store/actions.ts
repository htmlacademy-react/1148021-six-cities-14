...
export const updateCityOffers = createAction<{ cityName: CityName; offers: Array<TPlaceCard> }>('offers/updateByCity');
...
export const loadOffers = createAction<Array<TPlaceCard>>('data/loadOffers');
